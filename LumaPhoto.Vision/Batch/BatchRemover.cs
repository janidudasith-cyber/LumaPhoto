...
/// <summary>
/// Applies background removal to a sequence of image files.
/// Decoding and encoding are delegated to the host so this assembly remains
/// independent of UI frameworks and image codec implementations.
/// </summary>
