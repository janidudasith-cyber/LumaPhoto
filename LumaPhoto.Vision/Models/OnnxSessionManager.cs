...
public sealed class OnnxSessionManager : IDisposable
{
    ...
    public OnnxSessionManager(ModelDescriptor descriptor, string modelPath, bool preferGpu = true)
    {
        ...
        // Delay model loading until warm-up or the first inference request.
    ...
    /// <summary>
    /// U²-Net emits seven side outputs (d0..d6). d0 is the fused prediction used
    /// for the final mask; the remaining outputs are training artefacts.
    /// </summary>
